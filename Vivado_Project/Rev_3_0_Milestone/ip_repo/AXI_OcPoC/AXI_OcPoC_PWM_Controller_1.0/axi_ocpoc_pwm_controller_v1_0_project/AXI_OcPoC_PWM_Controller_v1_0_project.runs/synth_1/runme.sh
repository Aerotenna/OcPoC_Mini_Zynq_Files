...
HD_PWD='c:/users/aerotenna/desktop/axi_ocpoc/axi_ocpoc_pwm_controller_1.0/axi_ocpoc_pwm_controller_v1_0_project/AXI_OcPoC_PWM_Controller_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_OcPoC_PWM_Controller_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source AXI_OcPoC_PWM_Controller_v1_0.tcl
