...
HD_PWD='/home/hding/Projects/flight-control/trunk/OcPoC_Zynq_Mini/Rev_3_0_Milestone/ocpoc_clean/ocpoc_rev1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ocpoc_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ocpoc_top.tcl
