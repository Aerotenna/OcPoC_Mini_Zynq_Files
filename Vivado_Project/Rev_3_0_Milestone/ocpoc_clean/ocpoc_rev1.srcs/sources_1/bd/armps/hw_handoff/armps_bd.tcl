...
proc create_root_design { parentCell } {
  ...
  set pwm_9 [ create_bd_port -dir O pwm_9 ]
  set pwm_10 [ create_bd_port -dir O pwm_10 ]
  set pwm_11 [ create_bd_port -dir O pwm_11 ]
...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_net -net AXI_OcPoC_PWM_Controller_0_pwm9 [get_bd_ports pwm_9] [get_bd_pins AXI_OcPoC_PWM_Controller_0/pwm9]
  connect_bd_net -net AXI_OcPoC_PWM_Controller_0_pwm10 [get_bd_ports pwm_10] [get_bd_pins AXI_OcPoC_PWM_Controller_0/pwm10]
  connect_bd_net -net AXI_OcPoC_PWM_Controller_0_pwm11 [get_bd_ports pwm_11] [get_bd_pins AXI_OcPoC_PWM_Controller_0/pwm11]
